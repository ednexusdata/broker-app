...
namespace EdNexusData.Broker.Data.Migrations.MsSql
{
    ...
    [Migration("20260621230310_ChangePayloadContentActionToCascade")]
    partial class ChangePayloadContentActionToCascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EdNexusData.Broker.Core.PayloadContentAction", b =>
                {
                    ...
                    b.HasIndex("PayloadContentId", "PayloadContentActionType")
                        .IsUnique()
                        .HasFilter("[PayloadContentActionType] IS NOT NULL");
