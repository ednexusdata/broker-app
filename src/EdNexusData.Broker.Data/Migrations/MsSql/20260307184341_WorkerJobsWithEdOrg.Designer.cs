...
namespace EdNexusData.Broker.Data.Migrations.MsSql
{
    ...
    [Migration("20260307184341_WorkerJobsWithEdOrg")]
    partial class WorkerJobsWithEdOrg
    {
        /// <inheritdoc />
                            ...
                            b1.OwnsMany("EdNexusData.Broker.Core.PayloadSettingsContentType", "PayloadContents", b2 =>
                                {
                                    ...
                                    b2.HasKey("IncomingPayloadSettingsEducationOrganizationPayloadSettingsId", "__synthesizedOrdinal");
                            ...
                            b1.OwnsMany("EdNexusData.Broker.Core.PayloadSettingsContentType", "PayloadContents", b2 =>
                                {
                                    ...
                                    b2.HasKey("OutgoingPayloadSettingsEducationOrganizationPayloadSettingsId", "__synthesizedOrdinal");
