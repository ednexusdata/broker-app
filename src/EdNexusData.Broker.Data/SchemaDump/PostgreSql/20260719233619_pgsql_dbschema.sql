...
BEGIN
    ...
    VALUES ('20250112170235_InitialMigration', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250215230118_AddConnectorRefs') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250215230118_AddConnectorRefs', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250216214241_ConnectorRefUniqueConstraint') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250216214241_ConnectorRefUniqueConstraint', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250426181339_EnabledForEdOrgConnector') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250426181339_EnabledForEdOrgConnector', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250531140158_AddSettings') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250531140158_AddSettings', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213183858_DistributedCache') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251213183858_DistributedCache', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184018_KeysAndIndexesOnUserTables') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184018_KeysAndIndexesOnUserTables') THEN
    ALTER TABLE "UserRoles" ADD CONSTRAINT "FK_UserRoles_Users_CreatedBy" FOREIGN KEY ("CreatedBy") REFERENCES "Users" ("UserId") ON DELETE RESTRICT;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184018_KeysAndIndexesOnUserTables') THEN
    ALTER TABLE "Users" ADD CONSTRAINT "FK_Users_Users_CreatedBy" FOREIGN KEY ("CreatedBy") REFERENCES "Users" ("UserId") ON DELETE RESTRICT;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184018_KeysAndIndexesOnUserTables') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260307184018_KeysAndIndexesOnUserTables', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184309_WorkerJobsWithEdOrg') THEN
    ALTER TABLE "Worker_Jobs" ADD "EducationOrganizationId" uuid;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184309_WorkerJobsWithEdOrg') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260307184309_WorkerJobsWithEdOrg', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621175229_ChangePayloadContentActionToCascade') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621175229_ChangePayloadContentActionToCascade') THEN
    ALTER TABLE "PayloadContentActions" ALTER COLUMN "PayloadContentId" SET NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621175229_ChangePayloadContentActionToCascade') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621175229_ChangePayloadContentActionToCascade', '10.0.10');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260719225815_ActivityLog') THEN
    CREATE TABLE "ActivityLog" (
        ...
        CONSTRAINT "FK_ActivityLog_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("UserId") ON DELETE RESTRICT
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260719225815_ActivityLog') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260719225815_ActivityLog', '10.0.10');
    END IF;
END $EF$;
COMMIT;
