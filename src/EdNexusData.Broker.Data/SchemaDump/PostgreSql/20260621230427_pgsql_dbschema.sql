...
BEGIN
    ...
    VALUES ('20250112170235_InitialMigration', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250215230118_AddConnectorRefs') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250215230118_AddConnectorRefs', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250216214241_ConnectorRefUniqueConstraint') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250216214241_ConnectorRefUniqueConstraint', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250426181339_EnabledForEdOrgConnector') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250426181339_EnabledForEdOrgConnector', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250531140158_AddSettings') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250531140158_AddSettings', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20251213183858_DistributedCache') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20251213183858_DistributedCache', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184018_KeysAndIndexesOnUserTables') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260307184018_KeysAndIndexesOnUserTables', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260307184309_WorkerJobsWithEdOrg') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260307184309_WorkerJobsWithEdOrg', '10.0.9');
    END IF;
END $EF$;
COMMIT;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260621175229_ChangePayloadContentActionToCascade') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260621175229_ChangePayloadContentActionToCascade', '10.0.9');
    END IF;
END $EF$;
COMMIT;
