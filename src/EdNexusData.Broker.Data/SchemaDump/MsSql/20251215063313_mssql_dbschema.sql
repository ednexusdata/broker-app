...
BEGIN
    ...
    VALUES (N'20250419045026_InitialMigration', N'8.0.22');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250502134638_EnabledForEdOrgConnector', N'8.0.22');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250602015833_UpdatedMigrationsAndDistCache', N'8.0.22');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250806060236_DistributedCache', N'8.0.22');
END;
GO
