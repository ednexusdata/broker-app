...
BEGIN
    ...
    VALUES (N'20250419045026_InitialMigration', N'10.0.1');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250502134638_EnabledForEdOrgConnector', N'10.0.1');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250602015833_UpdatedMigrationsAndDistCache', N'10.0.1');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250806060236_DistributedCache', N'10.0.1');
END;
