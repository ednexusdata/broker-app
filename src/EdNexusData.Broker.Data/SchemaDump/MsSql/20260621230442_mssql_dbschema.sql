...
BEGIN
    ...
    VALUES (N'20250419045026_InitialMigration', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250502134638_EnabledForEdOrgConnector', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250602015833_UpdatedMigrationsAndDistCache', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250806060236_DistributedCache', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20251230211519_AddEdOrgCodes', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260307184227_KeysAndIndexesOnUserTables', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260307184341_WorkerJobsWithEdOrg', N'10.0.9');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260621230310_ChangePayloadContentActionToCascade', N'10.0.9');
END;
