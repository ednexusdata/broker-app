...
BEGIN
    ...
    VALUES (N'20250419045026_InitialMigration', N'10.0.10');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250502134638_EnabledForEdOrgConnector', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250602015833_UpdatedMigrationsAndDistCache'
)
BEGIN
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_Settings_Key] ON [Settings] ([Key]) WHERE [Key] IS NOT NULL');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250602015833_UpdatedMigrationsAndDistCache', N'10.0.10');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250806060236_DistributedCache', N'10.0.10');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20251230211519_AddEdOrgCodes', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260307184227_KeysAndIndexesOnUserTables'
)
BEGIN
    CREATE INDEX [IX_Worker_Jobs_CreatedBy] ON [Worker_Jobs] ([CreatedBy]);
END;
...
BEGIN
    ALTER TABLE [UserRoles] ADD CONSTRAINT [FK_UserRoles_Users_CreatedBy] FOREIGN KEY ([CreatedBy]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;
END;
...
BEGIN
    ALTER TABLE [Worker_Jobs] ADD CONSTRAINT [FK_Worker_Jobs_Users_CreatedBy] FOREIGN KEY ([CreatedBy]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260307184227_KeysAndIndexesOnUserTables', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260307184341_WorkerJobsWithEdOrg'
)
BEGIN
    ALTER TABLE [Worker_Jobs] ADD [EducationOrganizationId] uniqueidentifier NULL;
END;
...
BEGIN
    CREATE INDEX [IX_Worker_Jobs_EducationOrganizationId] ON [Worker_Jobs] ([EducationOrganizationId]);
END;
...
BEGIN
    ALTER TABLE [Worker_Jobs] ADD CONSTRAINT [FK_Worker_Jobs_EducationOrganizations_EducationOrganizationId] FOREIGN KEY ([EducationOrganizationId]) REFERENCES [EducationOrganizations] ([EducationOrganizationId]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260307184341_WorkerJobsWithEdOrg', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260621230310_ChangePayloadContentActionToCascade'
)
BEGIN
    ALTER TABLE [PayloadContentActions] DROP CONSTRAINT [FK_PayloadContentActions_PayloadContents_PayloadContentId];
END;
...
BEGIN
    DROP INDEX [IX_PayloadContentActions_PayloadContentId_PayloadContentActionType] ON [PayloadContentActions];
END;
...
BEGIN
    ...
    WHERE ([d].[parent_object_id] = OBJECT_ID(N'[PayloadContentActions]') AND [c].[name] = N'PayloadContentId');
    IF @var IS NOT NULL EXEC(N'ALTER TABLE [PayloadContentActions] DROP CONSTRAINT ' + @var + ';');
    ALTER TABLE [PayloadContentActions] ALTER COLUMN [PayloadContentId] uniqueidentifier NOT NULL;
END;
...
BEGIN
    EXEC(N'CREATE UNIQUE INDEX [IX_PayloadContentActions_PayloadContentId_PayloadContentActionType] ON [PayloadContentActions] ([PayloadContentId], [PayloadContentActionType]) WHERE [PayloadContentActionType] IS NOT NULL');
END;
...
BEGIN
    ALTER TABLE [PayloadContentActions] ADD CONSTRAINT [FK_PayloadContentActions_PayloadContents_PayloadContentId] FOREIGN KEY ([PayloadContentId]) REFERENCES [PayloadContents] ([PayloadContentId]) ON DELETE CASCADE;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260621230310_ChangePayloadContentActionToCascade', N'10.0.10');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260719233609_ActivityLog'
)
BEGIN
    CREATE TABLE [ActivityLog] (
        ...
        CONSTRAINT [FK_ActivityLog_Requests_RequestId] FOREIGN KEY ([RequestId]) REFERENCES [Requests] ([RequestId]) ON DELETE SET NULL,
        CONSTRAINT [FK_ActivityLog_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION
    );
END;
...
BEGIN
    CREATE INDEX [IX_ActivityLog_RequestId] ON [ActivityLog] ([RequestId]);
END;
...
BEGIN
    CREATE INDEX [IX_ActivityLog_UserId_CreatedAt] ON [ActivityLog] ([UserId], [CreatedAt]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260719233609_ActivityLog', N'10.0.10');
END;
